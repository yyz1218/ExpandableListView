...
import android.esports.zzdj.com.expandablelistview.adapter.NormalExpandableListAdapter;
import android.esports.zzdj.com.expandablelistview.adapter.OnGroupExpandedListener;
...
public class NormalExpandActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final NormalExpandableListAdapter adapter = new NormalExpandableListAdapter(Constant.GirlS, Constant.DETAILS);
        ...
        mExpandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                Toast.makeText(NormalExpandActivity.this, Constant.DETAILS[groupPosition][childPosition], Toast.LENGTH_SHORT).show();
                return true;
            }
        });
    }
